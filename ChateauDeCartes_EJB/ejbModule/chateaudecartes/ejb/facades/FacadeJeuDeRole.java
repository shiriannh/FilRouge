...
public class FacadeJeuDeRole extends AbstractDaoEntrepriseEdition<JeuDeRole> {
	...
	public void ajouterRessources(String titre, byte[] data, JeuDeRole jdr) {
		JeuDeRole jdrRelue = this.read(jdr.getId());
		if (jdrRelue.getRsc() == null) {
			jdrRelue.setRsc(new LinkedList<Ressource>());
		}
